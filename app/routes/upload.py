...
from app.middleware.security import validate_secure_filename, validate_uploaded_file
...
async def upload_media_file(file: UploadFile = File(...), db: Session = Depends(get_db)):
    """
